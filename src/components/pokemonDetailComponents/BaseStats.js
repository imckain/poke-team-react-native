  ...
  return (
    <View style={styles.infoContainer}>
      <View style={styles.baseStatContainer}>
        <Text allowFontScaling={false} adjustsFontSizeToFit={true} style={[styles.baseStatNameText, {fontSize: detailFontSize}]}>{results.stats[0].stat.name}:</Text>
      ...
      <View style={styles.baseStatContainer}>
        <Text allowFontScaling={false} adjustsFontSizeToFit={true} style={[styles.baseStatNameText, {fontSize: detailFontSize}]}>{results.stats[1].stat.name}:</Text>
      ...
      <View style={styles.baseStatContainer}>
        <Text allowFontScaling={false} adjustsFontSizeToFit={true} style={[styles.baseStatNameText, {fontSize: detailFontSize}]}>{results.stats[2].stat.name}:</Text>
      ...
      <View style={styles.baseStatContainer}>
        <Text allowFontScaling={false} adjustsFontSizeToFit={true} style={[styles.baseStatNameText, {fontSize: detailFontSize}]}>{results.stats[5].stat.name}:</Text>
